...
# при использовании вм поддерживаемой Docker-machine - выполняет кросс-монтирование(с пересечением границ файловых систем) домашнего каталога для упрощения разработки
